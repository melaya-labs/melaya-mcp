...
[![Tools](https://img.shields.io/badge/tools-81_across_8_domains-22D3EE)](#what-it-can-do)
...
The tool list your assistant receives is filtered to what you granted, so connecting for phone control alone shows **23 tools rather than all 81**. If a capability seems missing, you declined it; reconnect and approve it.
